...
import { createIntegrationApiClient } from '../app/web/integration/api-client.js';
...
test('integrated browser client sends bearer auth and consumes normalized SSE', async () => {
  let authorization;
