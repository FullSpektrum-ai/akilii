...
export function createWorkService(rawPorts) {
  ...
  async function list(input = {}) {
    ...
    if (!subjectId) throw new TypeError('Work subject is required.');
    return ports.workRepository.list({ subjectId, limit: input.limit });
  }
  ...
  async function create(input = {}) {
    ...
    return {
      work: saved,
      receipt: { operation: 'work.create', workId: saved.id, version: saved.version, approvalRef },
    };
  }
